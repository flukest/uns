...
## Guidelines
* Adding a new function can be done by copying [TEMPLATE.md](TEMPLATE.md), renaming it, and editing it as needed.
...
This can be done through [github pull requests](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/about-pull-requests). Clone the repository, make your changes, then submit a pull request. The pull request will be reviewed by several members of the UNS before it is merged.
